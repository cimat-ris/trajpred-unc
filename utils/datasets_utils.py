...
from utils.constants import (
	...
	TRAIN_DATA_STR, TEST_DATA_STR, VAL_DATA_STR, MUN_POS_CSV, DATASETS_DIR, ETH_UCY_NAMES
)
import logging
...
def get_ethucy_dataset(args):
	...
	training_data, validation_data, test_data, homography = setup_loo_experiment(DATASETS_DIR,ETH_UCY_NAMES,args.id_test,experiment_parameters,pickle_dir='pickle',use_pickled_data=args.pickle)
