...
def main():
    ...
    training_data, validation_data, test_data, test_homography = setup_loo_experiment(SDD_DATASETS_DIR, SDD_NAMES
,args.id_test,experiment_parameters,pickle_dir='pickle',use_pickled_data=args.pickle, sdd=True, compute_neighbors=False)
